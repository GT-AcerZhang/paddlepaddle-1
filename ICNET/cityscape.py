...
IGNORE_LABEL = 255
NUM_CLASSES = 6
TRAIN_DATA_SHAPE = (3, 1200, 1200)
TEST_DATA_SHAPE = (3, 1200, 1200)
...
class DataGenerater:
    ...
    def load(self, image, label):
        ...
        # print(dataset.image.load_image(
        #     DATA_PATH + "/" + label, is_color=False))
        label = dataset.image.load_image(
            DATA_PATH + "/" + label, is_color=True).astype("float32")
